...
let confPath = path.join(process.cwd(), program.config || './apktool-config.json');
...
if (program.help) {
    console.log("");
    console.log("");
    console.log("Usage: cli-apktool [options]");
    ...
    console.log("  --config             config file def: ./apktool-config.json");
